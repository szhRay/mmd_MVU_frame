...
- 新会话先读 `main.md` 和 `plan.md`，再读 `README.md`、`AUTHORING.md`、`API.md` 与 `AI_WORKFLOW.md`。
- 必须先通过自然语言对话了解作者需求，再按 MVU 数据模型、变量注入、全局美化、状态栏与舞台、发送/流式/完成行为五组推进；每组先确认业务与界面结果，再修改该组。
...
- 常规作者制作以项目文档和 `API.md` 为准；API 未覆盖、验证错误无法解释、行为与文档不一致或用户要求诊断框架时，才检查完整平台规范与 `src/framework/`。技能的必读规则仍优先。
